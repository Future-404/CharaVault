...
public final class CardDao_Impl implements CardDao {
  ...
  public CardDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCardEntity = new EntityInsertionAdapter<CardEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `cards` (`id`,`name`,`creator`,`description`,`personality`,`scenario`,`firstMes`,`systemPrompt`,`tagsJson`,`alternateGreetingsJson`,`rawJsonData`,`imagePath`,`isFavorite`,`createdAt`,`updatedAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfCardEntity = new EntityDeletionOrUpdateAdapter<CardEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `cards` SET `id` = ?,`name` = ?,`creator` = ?,`description` = ?,`personality` = ?,`scenario` = ?,`firstMes` = ?,`systemPrompt` = ?,`tagsJson` = ?,`alternateGreetingsJson` = ?,`rawJsonData` = ?,`imagePath` = ?,`isFavorite` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
  ...
  public Flow<List<CardEntity>> getAllCardsFlow() {
    final String _sql = "SELECT * FROM cards ORDER BY isFavorite DESC, updatedAt DESC";
      ...
      public List<CardEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CardEntity(_tmpId,_tmpName,_tmpCreator,_tmpDescription,_tmpPersonality,_tmpScenario,_tmpFirstMes,_tmpSystemPrompt,_tmpTagsJson,_tmpAlternateGreetingsJson,_tmpRawJsonData,_tmpImagePath,_tmpIsFavorite,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public CardEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new CardEntity(_tmpId,_tmpName,_tmpCreator,_tmpDescription,_tmpPersonality,_tmpScenario,_tmpFirstMes,_tmpSystemPrompt,_tmpTagsJson,_tmpAlternateGreetingsJson,_tmpRawJsonData,_tmpImagePath,_tmpIsFavorite,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
